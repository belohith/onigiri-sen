...
const californiaStores: Store[] = [
  { name:"Coming soon — San Francisco", address:"", hours:"", phone:"", mapsUrl:"" },
];

// Embedded Google My Maps iframe src
  ...
  return (
    <section style={{ padding:"64px 80px 100px", background:"#fdf8f4", position:"relative" as const }}>
      ...
      <div style={{ display:"flex", justifyContent:"center", marginBottom:32 }}>
        <div style={{ border:"2px solid #6f471c", borderRadius:999, padding:"10px 36px", fontWeight:700, fontSize:16, color:"#6f471c" }}>
      ...
      <div style={{ maxWidth:820, margin:"0 auto" }}>
        ...
        <div style={{ display:"flex", borderRadius:"20px 20px 0 0", overflow:"hidden", border:"2px solid #ed7e80", borderBottom:"none" }}>
          {(["seattle","california"] as const).map((tab) => (
            <button
              ...
              style={{
                flex:1, padding:"13px", textAlign:"center" as const,
        ...
        {/* Search */}
        {activeTab === "seattle" && (
          <div style={{ border:"2px solid #ed7e80", borderTop:"1px solid #f5d0d0", borderBottom:"none", background:"#fff", padding:"12px 16px" }}>
        ...
        {/* California: graphic. Washington: store list */}
          ...
          {filtered.length === 0 ? (
            ...
            store.mapsUrl ? (
              <div
                key={store.name}
                style={{
                  borderBottom: i < filtered.length-1 ? "1px solid #f5ede8" : "none",
                  background:"#fff",
                }}
              >
                <a
                ...
                >
                  ...
                  <div style={{ flex:1, minWidth:0 }}>
                    <div style={{ fontSize:13, fontWeight:700, color:"#5a3020" }}>{store.name}</div>
                ...
                {/* Phone on its own line — not nested in <a> */}
                {store.phone && (
              ...
              <div
                key={store.name}
                style={{ padding:"16px 20px", color:"#bbb", fontSize:13, textAlign:"center" as const }}
              >
                {store.name}
              </div>
            )
