        ...
        <section style={{
          ...
          <div>
            ...
            {[
              ...
              { icon:"/images/phone.png", label:t("Phone","電話番号"),    value:"(206) 445-8086",       href:"tel:2064458086" },
              ...
              <div key={row.label} style={{ display:"flex", alignItems:"center", gap:18, marginBottom:24 }}>
                <div style={{ width:50, height:50, borderRadius:14, border:"2px solid #e8ddd4", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, background:"#fff" }}>
                  <img src={row.icon} alt={row.label} style={{ width:28, height:28, objectFit:"contain" as const }} />
                </div>
                <div>
                  ...
                  <a
                    ...
                    style={{ color:"#6f471c", fontWeight:600, fontSize:15, textDecoration:"none" }}
                  >
                    {row.value}
                  </a>
                </div>
          ...
          <div style={{ background:"#fff9f5", borderRadius:24, padding: isMobile ? "28px 20px" : "40px", boxShadow:"0 4px 28px rgba(0,0,0,0.08)" }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap:16, marginBottom:16 }}>
              <div>
                ...
                <input type="tel" placeholder="(206) 555-0100" style={input} />
              </div>
              <div>
                ...
                <div style={{ position:"relative" as const }}>
                  <select
                    ...
                    style={{ ...input, appearance:"none", paddingRight:36 } as React.CSSProperties}
                  >
            ...
            <div style={{ marginBottom:16 }}>
              ...
              <div style={{ position:"relative" as const }}>
                <select style={{ ...input, appearance:"none", paddingRight:36 } as React.CSSProperties}>
