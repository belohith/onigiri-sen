...
export default function ProductsPage() {
  ...
  const dietary = [
    {
      label: t("Gluten-Free (GF)", "グルテンフリー (GF)"),
      lc: "#fff",
      lb: "#8faa3a",
      ic: "#5a8a20",
      items: t(
        "Salmon · Spicy Tuna Mayo* · Yuzu Salmon · Ume",
        "鮭 ・ スパイシーツナマヨ* ・ 柚子サーモン ・ 梅"
      ),
    },
    {
      label: t("Vegan", "ヴィーガン"),
      ...
      >
        ...
        <section
          style={{
            background: "#fff9f5",
            textAlign: "center",
            padding: isMobile ? "56px 24px 0" : "72px 80px 0",
            whiteSpace: "pre-line",
          }}
        >
          <h1
        ...
        >
          ...
          >
            {t(
              "Selected Ingredients, Inclusive Choices",
              "厳選された食材、多様な選択肢"
            )}
          </h2>
        ...
        >
          ...
          >
            {t(
              "*Spicy Tuna Mayo is Organic and Gluten-Free for PCC locations only.",
              "*スパイシーツナマヨのオーガニック・グルテンフリーはPCCロケーションのみ対応しています。"
            )}
          </p>
        </section>
          ...
          >
            <Link
              ...
              style={{
                ...
                textDecoration: "none",
                boxShadow:
                  "0 4px 20px rgba(237,126,128,0.35)",
              }}
            >
              {t(
                "Read Our Story →",
